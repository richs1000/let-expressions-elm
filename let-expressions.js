...
var _user$project$LetExpressions$subscriptions = function (model) {
	return _user$project$Ports$ssData(_user$project$MessageTypes$GetValuesFromSS);
};
var _user$project$LetExpressions$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Model$init, view: _user$project$View$view, update: _user$project$Update$update, subscriptions: _user$project$LetExpressions$subscriptions})
};

var Elm = {};
Elm['LetExpressions'] = Elm['LetExpressions'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['LetExpressions'], 'LetExpressions', typeof _user$project$LetExpressions$main === 'undefined' ? null : _user$project$LetExpressions$main);
